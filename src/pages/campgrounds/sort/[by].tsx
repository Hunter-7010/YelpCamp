...
const param = router.query.by as string
  ...
  return (
    <div className="flex flex-col items-center md:h-full">
      ...
      <div className="flex h-12 w-full items-center justify-between bg-white shadow-lg flex-wrap">
        <DropDown/>
        <div className="">Sorted by: {param}</div>
...
export default SortedCampgrounds; //MUST EXPORT SO THAT NEXT JS FINDS IT
